# 2026년 5회차 추천도서 포스터 자료

이 폴더는 **2026년 5회차 추천도서 포스터 자료**를 보관하는 곳입니다.
...
이 폴더는 추천도서 홍보용 포스터를 보관하고, 필요한 관리자가 언제든지 다운로드해서 사용할 수 있도록 하기 위한 공간입니다.
...
```text
poster-2026-05-web-main.jpg
poster-2026-05-web-square.png
poster-2026-05-web-story.png
```
...
```text
poster-2026-05-print-a4.pdf
poster-2026-05-print-a3.pdf
poster-2026-05-print-a4.png
```
...
```text
poster-2026-05-source.pptx
poster-2026-05-source.ai
poster-2026-05-source.psd
```
...
```text
issues/2026-05/posters/web/poster-2026-05-web-main.jpg
```

공개 주소:

```text
https://libjeju.github.io/books/issues/2026-05/posters/web/poster-2026-05-web-main.jpg
```
...
```text
issues/2026-05/posters/print/poster-2026-05-print-a4.pdf
```

공개 주소:

```text
https://libjeju.github.io/books/issues/2026-05/posters/print/poster-2026-05-print-a4.pdf
```
...
```text
issues/2026-05/posters/source/poster-2026-05-source.pptx
```

공개 주소:

```text
https://libjeju.github.io/books/issues/2026-05/posters/source/poster-2026-05-source.pptx
```
...
```text
posters/web/poster-2026-05-web-main.jpg
```
...
```text
1. 파일명 변경: poster-2026-05-web-main.jpg
2. GitHub 접속: https://github.com/libjeju/books
3. issues → 2026-05 → posters → web 이동
...
```text
1. 파일명 변경: poster-2026-05-print-a4.pdf
2. GitHub 접속: https://github.com/libjeju/books
3. issues → 2026-05 → posters → print 이동
4. Add file → Upload files 클릭
5. 파일 드래그
6. Commit message 입력
7. Commit changes 클릭
...
```text
1. 공개 가능한 원본인지 확인
2. 파일명 변경: poster-2026-05-source.pptx
3. GitHub 접속: https://github.com/libjeju/books
4. issues → 2026-05 → posters → source 이동
